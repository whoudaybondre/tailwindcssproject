...
const Body = () => {
  return (
    <div className='space-y-4 lg:flex '>
      ...
      <p className='font-lato text-gray-400 my-2'>With Hoster, get your website up and runnning in no less than 5 minutes with the most competitive pricing packages</p>
      ...
      <div className='flex gap-2'>
        ...
        <p className='font-lato text-gray-400 my-1'>No spam, ever . Unsubscribe anytime</p>
      </div>
      </div>
    </div>
  )
