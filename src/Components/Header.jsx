  ...
  return (
    <div className='flex justify-between'>
      ...
      <ul className='hidden lg:flex justify-between items-center font-lato text-gray-400 gap-6'>
        <li className=' hover:text-black'><a href='#'>Plans</a></li>
        <li className=' hover:text-black'><a href='#'>Find Domain</a></li>
        <li className=' hover:text-black'><a href='#'>Why Hoster</a></li>
      </ul>
      <div className='hidden lg:flex justify-center items-center font-lato gap-6'>
        <a href='#' className='text-gray-400 hover:text-black'>Sign In</a>
